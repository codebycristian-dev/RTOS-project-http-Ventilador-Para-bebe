...
volatile uint16_t flags = 0; //definición de bandera para indicar que ocurrio un evento de interrucion 
...
void isr_install()
{
    ...
    ret = gpio_isr_handler_add(GPIO_NUM_15, isr_handler, NULL);
    if (ret != ESP_OK)
    {
